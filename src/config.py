...
class Settings(BaseSettings):
    ...
    # Legacy default directories (for backward compatibility)
    ...
    def ensure_directories(self) -> None:
        ...
        for d in [self.data_dir, self.runs_dir, self.rosetta_dir, self.memos_dir, self.debate_dir, self.reports_dir]:
